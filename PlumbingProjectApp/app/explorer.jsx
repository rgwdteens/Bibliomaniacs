...
export default function AllReviews() {
  ...
  const fetchCommunityRating = async (bookId) => {
    try {
      const res = await fetch(`https://bibliomaniacs-ytnd.onrender.com/get_community_rating/${bookId}`);
      ...
      const res2 = await fetch(`https://bibliomaniacs-ytnd.onrender.com/get_users_community_rating/${bookId}`, {
        method: "POST",
  ...
  const hydGenres = async (book) => {
    ...
    try {
      const res = await fetch(`https://bibliomaniacs-ytnd.onrender.com/get_reviews?search=${book.book_title}`);
      const data = await res.json();
  ...
  const handleSubmitCommunityRating = async (bookId, star) => {
    ...
    try {
      ...
      const res = await fetch("https://bibliomaniacs-ytnd.onrender.com/submit_community_rating", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchReviews = async () => {
    ...
    try {
      ...
      if (user) {
        ...
        res = await fetch(
          "https://bibliomaniacs-ytnd.onrender.com/get_recommended_reviews",
          {
            method: "POST",
            headers: {
