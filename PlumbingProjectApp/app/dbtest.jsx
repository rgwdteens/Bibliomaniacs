...
export default function App() {
  ...
  const addBook = async () => {
    ...
    try {
      ...
      const res = await fetch("https://bibliomaniacs-ytnd.onrender.com/add_book", {
        method: "POST",
  ...
  const submitReview = async () => {
    ...
    try {
      ...
      const res = await fetch("https://bibliomaniacs-ytnd.onrender.com/submit_review", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          idToken,
  ...
  const fetchBooks = async () => {
    try {
      const res = await fetch("https://bibliomaniacs-ytnd.onrender.com/get_books");
      const data = await res.json();
      setBooks(data);
    } catch (err) {
      console.error(err);
  ...
  const fetchReviews = async () => {
    try {
      const res = await fetch("https://bibliomaniacs-ytnd.onrender.com/get_reviews");
      const data = await res.json();
      setReviews(data);
    } catch (err) {
      console.error(err);
